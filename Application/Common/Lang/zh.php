...
return array(
    ...
    'reg_agreement' => "请阅读并接受《erdangjiade 用户使用协议》！",
    'reg_email_has' => "该邮箱已存在！",
    'login_pwd_empty' => "请输入密码！",
    'login_user_login' => '用户登录',
    'login_user_reg' => '立即注册',
    'login_no_account' => '还没有erdangjiade账号？',
    'login_forget_pwd' => '忘记密码',
    'login_login' => '登 录',
    //注册成功提示
    'regsuc_thanks' => '非常感谢',
    'regsuc_reg_success' => '您已经成功注册erdangjiade！',
    'regsuc_email_send' => "<strong>一封<font color='red'>验证邮件</font>已经发送到您的注册邮箱，验证后即可登录erdangjiade。如果您无法找到该验证邮件，请检查您注册时填写的邮件地址是否正确，或者到<font color='red'>垃圾邮件箱</font>里查找。</strong><br />
                <span id='second'>30</span>秒钟后自动<a href='http://www.erdangjiade.com'>返回</a>。",
    //click中转页
    'click_title' => '您正在从erdangjiade离开',
