									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php if(is_array($vr_data)): $i = 0; $__LIST__ = $vr_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><input type="hidden" name="id" value="<?php echo ($row["id"]); ?>">
													<tr>
														<td class="center">
															<label>
																<input type="checkbox" class="ace" />
														...
														<td><img src="/Public/Uploads/<?php echo ($row["newsimg"]); ?>" width="50" height="50"/></td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo U('News/newsUpdate');?>?id=<?php echo ($row["id"]); ?>">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo U('News/newsDel');?>?id=<?php echo ($row["id"]); ?>">
