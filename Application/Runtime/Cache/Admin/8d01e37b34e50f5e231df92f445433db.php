								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-responsive">
                                            <form action="userList" id="search" method="post">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                                ...
                                                <?php if(is_array($adminUserList)): foreach($adminUserList as $key=>$row): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" class="ace" />
																<span class="lbl"></span>
														...
														<td class="hidden-480"><?php echo (date('Y-m-d H:m:s',$row["createtime"])); ?></td>
														<td><?php echo (date('Y-m-d H:m:s',$row["modifytime"])); ?></td>

														<td class="hidden-480">
															<span class="label label-sm label-warning"><?php echo ($row["rolename"]); ?></span>
														</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo U('Web/userUpdate');?>?id=<?php echo ($row["id"]); ?>">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="http://www.cms2.cn/Admin/Ajax/userdel?id=<?php echo ($row["id"]); ?>">
