...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-responsive">
            <form action="messageLists" id="search" method="post">
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                ...
                <?php if(is_array($messageLists)): foreach($messageLists as $key=>$row): ?><tr>
                        <td class="center">
                            <label>
                                <input type="checkbox" class="ace" />
                                <span class="lbl"></span>
                        ...
                        <td class="hidden-480"><?php if($row["type"] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="green" href="<?php echo U('Web/messageUpdate');?>?id=<?php echo ($row["id"]); ?>">
