...
<li class="sidebar-dashboard <?php if($leftSadebarActive == 1): ?>active open<?php endif; ?>">
    <a href="http://cms.erdangjiade.com/Admin/index/">
                 ...
                 <b class="arrow icon-angle-down"></b>
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php if($leftInvitationAdd == 1): ?>class="active"<?php endif; ?>>
                            <a href="http://cms.erdangjiade.com/Admin/User/invitationAdd">
...
<li <?php if($leftCategoryManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftCategoryAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://cms.erdangjiade.com/Admin/Category/categoryAdd">
                <i class="icon-double-angle-right"></i>
                添加分类
            </a>
        </li>
...
<li <?php if($leftLearnManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftLearnAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://cms.erdangjiade.com/Admin/Learn/learnInformationAdd">
                <i class="icon-double-angle-right"></i>
                添加商品
            </a>
        </li>
...
<ul class="submenu">
    ...
    <a href="http://cms.erdangjiade.com/Admin/Wechat/wechatAdd">
        <i class="icon-double-angle-right"></i>
        添加公众号
    </a>
    </li>
    ...
    <a href="http://cms.erdangjiade.com/Admin/Wechat/brandAdd">
        <i class="icon-double-angle-right"></i>
        brandAdd
    </a>
    </li>
...
<li <?php if($leftNewsManager == 1): ?>class="active open"<?php endif; ?>  >
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftNewsAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://cms.erdangjiade.com/Admin/News/newsAdd">
                <i class="icon-double-angle-right"></i>
                添加新闻
            </a>
        </li>
...
<li <?php if($leftAdminUserManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftAdminUserAdd == 1): ?>class="active"<?php endif; ?> >
            <a href="http://cms.erdangjiade.com/Admin/Web/userAdd" class="dropdown-toggle">
                <i class="icon-plus"></i>
                添加管理员
            </a>
        </li>
        ...
        <a href="#" class="dropdown-toggle">
            ...
            <ul class="submenu">
                ...
                <a href="http://cms.erdangjiade.com/Admin/Seo/lists" >
                    <i class="icon-plus"></i>
                    SEO列表
                </a>
                </li>
                ...
                <a href="http://cms.erdangjiade.com/Admin/Seo/seoAdd">
                    <i class="icon-eye-open"></i>
                    添加SEO
                </a>
                </li>
...
<li <?php if($calendar == 1): ?>class="active"<?php endif; ?>>
    <a href="http://cms.erdangjiade.com/Admin/Other/calendar">
...
<script>
    function changeagentUserRecords(){
        ...
        $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms.erdangjiade.com/Admin/User/agentUserList';
            }
        })
    }
    function changecommonUserRecords(){
        ...
        $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms.erdangjiade.com/Admin/User/commonUserList';
            }
        })
    }
    function changeinvitationRecords(){
        ...
        $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms.erdangjiade.com/Admin/User/invitationLists';
            }
        })
    }
    function changeCategoryRecords(){
        ...
        $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
                if(rs==1){
                    location.href='http://cms.erdangjiade.com/Admin/Category/lists';
                }
         })
    }
            function changeLearnRecords(){
                ...
                $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms.erdangjiade.com/Admin/Learn/lists';
                    }
                })
            }
            ...
            function changeWechatRecords(){
                ...
                $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms.erdangjiade.com/Admin/Wechat/lists';
                    }
                })
            }
            function changeBrandRecords(){
                ...
                $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms.erdangjiade.com/Admin/Wechat/brandLists';
                    }
                })
            }
    ...
    function changenoticeRecords(){
        ...
        $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms.erdangjiade.com/Admin/News/noticeLists';
            }
        })
    }
    function changeactivityRecords(){
        ...
        $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms.erdangjiade.com/Admin/News/activityList';
            }
        })
    }
    function changenewsRecords(){
        ...
        $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms.erdangjiade.com/Admin/News/lists';
            }
        })
    }
            function changeOrderRecords(){
                ...
                $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms.erdangjiade.com/Admin/Order/lists';
                    }
                })
            }
            function changeWebRecords(){
                ...
                $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms.erdangjiade.com/Admin/Web/userList';
                    }
                })
            }
            function changeMessageRecords(){
                ...
                $.get('http://cms.erdangjiade.com/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms.erdangjiade.com/Admin/Web/messageLists';
                    }
                })
            }
</script>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form">
                            <?php if(is_array($userDetail)): foreach($userDetail as $key=>$row2): ?><div class="form-group">
                                    <input type="hidden" value="<?php echo ($row2["id"]); ?>" id="userid">
                                    <label for="form-field-1" class="col-sm-3 control-label no-padding-right">用户名： </label>
                                    <div class="col-sm-4">
                                        <input type="text" value="<?php echo ($row2["account"]); ?>" id="account">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="form-field-1" class="col-sm-3 control-label no-padding-right">昵称： </label>
                                    <div class="col-sm-4">
                                        <input type="text" value="<?php echo ($row2["username"]); ?>" id="username">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" class="ace" value="1" name="sex" <?php if($row2["sex"] == 1): ?>checked<?php endif; ?>>
                                            <span class="lbl">男</span>
                                        </label>
                                        <label>
                                            <input type="radio" class="ace" value="0" name="sex" <?php if($row2["sex"] == 0): ?>checked<?php endif; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" value="<?php echo ($row2["telephone"]); ?>" id="telephone">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="form-field-1" class="col-sm-3 control-label no-padding-right">邮箱： </label>
                                    <div class="col-sm-4">
                                        <input type="text" value="<?php echo ($row2["email"]); ?>" id="email">
                                    </div>
                                </div>
                                <!--<div class="form-group">-->
                                    <!--<label for="form-field-1" class="col-sm-3 control-label no-padding-right">地区： </label>-->
                                    <!--<div class="col-sm-4">-->
                                        <!--<input type="text" value="<?php echo ($row2["location"]); ?>" id="location">-->
                                    <!--</div>-->
                                <!--</div>-->
                                <div class="form-group">
                                    <label for="form-field-1" class="col-sm-3 control-label no-padding-right">积分： </label>
                                    <div class="col-sm-4">
                                        <input type="text" value="<?php echo ($row2["score"]); ?>" id="score">
                                    </div>
                                </div>
                                <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button type="button" class="btn btn-info" onclick="userUpdate();">
...
<script>
    function userUpdate(){
        ...
        var data = {"userid":userid,"account":account,"username":username,"sex":sex,"telephone":telephone,"email":email,"score":score};
        $.get('http://cms.erdangjiade.com/Admin/Ajax/userUpdate',data,function(rs){
            if(rs==1){
                alert('修改成功');
                location.href='../User/commonUserList';
            }else{
                alert('系统错误，请联系管理员');
            }
