                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form">
                            <?php if(is_array($CategoryUpdate)): foreach($CategoryUpdate as $key=>$row2): ?><div class="form-group">
                                <input type="hidden" value="<?php echo ($row2["id"]); ?>" id="categoryid">
                                <label for="form-field-1" class="col-sm-3 control-label no-padding-right">分类名称： </label>

                                <div class="col-sm-4">
                                    <?php echo ($row2["categoryname"]); ?>
                                    <!--<input type="text" class="col-xs-10 col-sm-6" placeholder="分类名称" id="categoryName" value="<?php echo ($row2["categoryname"]); ?>">-->
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="chosen-container chosen-container-multi" >
                                    <div class="col-sm-2">
                                        <input type="hidden" value="0," name="path" id="cpath"/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" class="ace" value="1" name="is_show" <?php if($row2["isshownav"] == 1): ?>checked<?php endif; ?>>
                                        <span class="lbl">显示</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="ace" value="0" name="is_show" <?php if($row2["isshownav"] == 0): ?>checked<?php endif; ?>>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button type="button" class="btn btn-info" onclick="categoryUpdate();">
...
<script>
    function categoryUpdate(){
        var isShow = $('input:radio[name=is_show]:checked').val();
        var categoryid=$('#categoryid').val();
        var data = {"isShow":isShow,"categoryid":categoryid};
        $.get('http://www.demo.cn/Admin/Ajax/categoryUpdate',data,function(rs){
            if(rs==1){
                alert('修改成功');
                location.href='../Category/lists';
            }else{
                alert('系统错误，请联系管理员');
            }
