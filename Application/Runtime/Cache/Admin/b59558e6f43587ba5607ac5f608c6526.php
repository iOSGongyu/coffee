...
<div class="row">
    <div class="col-xs-12">
        <form class="form-horizontal" role="form">
            ...
            <div class="form-group">
            <div class="chosen-container chosen-container-multi" style="width: 367px;margin-left: 334px;">
                <label for="form-field-select-1" class="col-sm-3 control-label no-padding-right">角色：</label>
                <div class="col-sm-9">
                <select id="form-field-select-1" class="form-control">
                    <option value="">&nbsp;</option>
                    <option value="0">超级管理员</option>
                    <option value="1">编辑总监</option>
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    <button type="button" class="btn btn-info" onclick="userAdd();">
...
<script type="text/javascript">
    ...
    function userAdd(){
        var user = $('#form-field-1').val();
        var passwd = $('#form-field-2').val();
        var role = $('#form-field-select-1').val();
        var roleName = $('#form-field-select-1').find("option:selected").text();
        var data = {"user":user,"passwd":passwd,"role":role,"roleName":roleName};
        $.get('http://www.cms2.cn/Admin/Ajax/userAdd',data,function(rs){
            if(rs==1){
                alert('添加成功');
                $('#form-field-1').val('')
                $('#form-field-2').val('')
