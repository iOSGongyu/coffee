...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" enctype="multipart/form-data" action="http://cms2.erdangjiade.cn/Admin/Ajax/newsAdd" method="post" id="addNews">

            <div class="form-group">
                <div class="chosen-container chosen-container-multi" >
                    <label for="form-field-select-1" class="col-sm-3 control-label no-padding-right">类别：</label>
                    <div class="col-sm-2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" class="col-xs-10 col-sm-6" placeholder="阅读量" name="clickNum" id="clickNum">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4" style='width:300px'>
                    <input type="file" id="id-input-file-1" name="newsImg"/>
                </div>
            </div>

            <div class="form-group" id="content1" style="display: block;">
                <label for="form-field-1" class="col-sm-3 control-label no-padding-right">正文：</label>
                <div class="wysiwyg-editor" id="editor1" name="editor1">
                </div>
                <input type='hidden' name='details' id='details' value=''>
            </div>
            <script src="<?php echo ($url_admin); ?>assets/js/jquery-1.8.3.min.js"></script>
            <script>
                $("#ztype").change(function(){
                    var res=$("select#ztype option:selected").val();
                    if(res==3){
                        $("#vr_type").css('display','block');
                        $("#content1").css('display','none');

                    }else{
                        $("#vr_type").css('display','none');
            ...
            <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                    <button type="button" class="btn btn-info" onclick="copyNewsHidden();">
