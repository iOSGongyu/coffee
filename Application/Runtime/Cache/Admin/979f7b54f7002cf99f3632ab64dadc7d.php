...
<ul class="submenu">
    ...
    <a href="http://www.demo.cn/Admin/Wechat/brandAdd">
        <i class="icon-double-angle-right"></i>
        brandAdd
    </a>
    </li>
    ...
    <div class="col-xs-12">
        ...
        <div class="table-responsive">
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                ...
                <?php if(is_array($seoList)): foreach($seoList as $key=>$row): ?><tr>
                        <td class="center">
                            <label>
                                <input type="checkbox" class="ace" />
                                <span class="lbl"></span>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="green" href="<?php echo U('Seo/seoUpdate');?>?id=<?php echo ($row["id"]); ?>">
                                    <i class="icon-pencil bigger-130"></i>
                                </a>

                                <a class="red" href="http://www.demo.cn/Admin/Ajax/seodel?id=<?php echo ($row["id"]); ?>">
...
<script>
    function logout(){
        ...
        $.get('http://www.demo.cn/Admin/Login/logout',data,function(rs){
            if(rs==1){
                alert('退出成功');
                location.href='http://www.demo.cn/Admin/Login/';
            }else{
                alert('系统错误，请联系管理员');
            }
        });
...
<script>
    ...
    function selectpage(){
        ...
        var data={"records":records};
        $.get('http://www.demo.cn/Admin/Ajax/articleNumber',data,function(rs,sta){
            if(rs==1){
                location.href='http://www.demo.cn/Admin/Seo/lists';
            }
        })
    }
