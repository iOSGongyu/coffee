...
<li class="sidebar-dashboard <?php if($leftSadebarActive == 1): ?>active open<?php endif; ?>">
    <a href="http://www.demo.cn/Admin/index/">
                 ...
                 <b class="arrow icon-angle-down"></b>
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php if($leftInvitationAdd == 1): ?>class="active"<?php endif; ?>>
                            <a href="http://www.demo.cn/Admin/User/invitationAdd">
...
<li <?php if($leftCategoryManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftCategoryAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://www.demo.cn/Admin/Category/categoryAdd">
                <i class="icon-double-angle-right"></i>
                添加分类
            </a>
        </li>
...
<li <?php if($leftLearnManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftLearnAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://www.demo.cn/Admin/Learn/learnInformationAdd">
                <i class="icon-double-angle-right"></i>
                添加案例
            </a>
        </li>
...
<ul class="submenu">
    ...
    <a href="http://www.demo.cn/Admin/Wechat/wechatAdd">
        <i class="icon-double-angle-right"></i>
        添加tag
    </a>
    </li>
...
<li <?php if($leftNewsManager == 1): ?>class="active open"<?php endif; ?>  >
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftNewsAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://www.demo.cn/Admin/News/newsAdd">
                <i class="icon-double-angle-right"></i>
                添加新闻
            </a>
        </li>
...
<li <?php if($leftAdminUserManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftAdminUserAdd == 1): ?>class="active"<?php endif; ?> >
            <a href="http://www.demo.cn/Admin/Web/userAdd" class="dropdown-toggle">
                <i class="icon-plus"></i>
                添加管理员
            </a>
        </li>
        ...
        <a href="#" class="dropdown-toggle">
            ...
            <ul class="submenu">
                ...
                <a href="http://www.demo.cn/Admin/Seo/lists" >
                    <i class="icon-plus"></i>
                    SEO列表
                </a>
                </li>
                ...
                <a href="http://www.demo.cn/Admin/Seo/seoAdd">
                    <i class="icon-eye-open"></i>
                    添加SEO
                </a>
                </li>
...
<li <?php if($calendar == 1): ?>class="active"<?php endif; ?>>
    <a href="http://www.demo.cn/Admin/Other/calendar">
...
<script>
    function changeagentUserRecords(){
        ...
        $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://www.demo.cn/Admin/User/agentUserList';
            }
        })
    }
    function changecommonUserRecords(){
        ...
        $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://www.demo.cn/Admin/User/commonUserList';
            }
        })
    }
    function changeinvitationRecords(){
        ...
        $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://www.demo.cn/Admin/User/invitationLists';
            }
        })
    }
    function changeCategoryRecords(){
        ...
        $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
                if(rs==1){
                    location.href='http://www.demo.cn/Admin/Category/lists';
                }
         })
    }
            function changeLearnRecords(){
                ...
                $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://www.demo.cn/Admin/Learn/lists';
                    }
                })
            }
            ...
            function changeWechatRecords(){
                ...
                $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://www.demo.cn/Admin/Wechat/lists';
                    }
                })
            }
            function changeBrandRecords(){
                ...
                $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://www.demo.cn/Admin/Wechat/brandLists';
                    }
                })
            }
    ...
    function changenoticeRecords(){
        ...
        $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://www.demo.cn/Admin/News/noticeLists';
            }
        })
    }
    function changeactivityRecords(){
        ...
        $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://www.demo.cn/Admin/News/activityList';
            }
        })
    }
    function changenewsRecords(){
        ...
        $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://www.demo.cn/Admin/News/lists';
            }
        })
    }
            function changeOrderRecords(){
                ...
                $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://www.demo.cn/Admin/Order/lists';
                    }
                })
            }
            function changeWebRecords(){
                ...
                $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://www.demo.cn/Admin/Web/userList';
                    }
                })
            }
            function changeMessageRecords(){
                ...
                $.get('http://www.demo.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://www.demo.cn/Admin/Web/messageLists';
                    }
                })
            }
</script>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="http://www.demo.cn/Admin/Ajax/newsUpdate" method="post" id="upBussiness">
                        <?php if(is_array($newsDetail)): foreach($newsDetail as $key=>$row2): ?><input type="hidden" name="id" value="<?php echo ($row2["id"]); ?>">
                            <div class="form-group">
                                <div class="chosen-container chosen-container-multi" >
                                    <label for="form-field-select-1" class="col-sm-3 control-label no-padding-right">分类：</label>
                                    <div class="col-sm-2">
                                        <input type="text"  value="<?php echo ($row2["categoryname"]); ?>" name="categoryId"   readonly="readonly" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="col-xs-10 col-sm-6" placeholder="标题" name="title" id="title" value="<?php echo ($row2["title"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="col-xs-10 col-sm-6" placeholder="描述" name="describe" id="describe" value="<?php echo ($row2["describe"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="form-field-1" class="col-sm-3 control-label no-padding-right">阅读量：</label>

                                <div class="col-sm-4">
                                    <input type="text" class="col-xs-10 col-sm-6" placeholder="阅读量" name="clicknum" id="clicknum" value="<?php echo ($row2["clicknum"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="form-field-1" class="col-sm-3 control-label no-padding-right">新闻图片：</label>

                                <div class="col-sm-4" style='width:300px'>
                                    <input type="file" id="id-input-file-2" name="newsImg"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="wysiwyg-editor" id="editor1" name="editor1"><?php echo (html_entity_decode($row2["details"])); ?></div>
...
<script>
    function copyContentToHidden(){
        ...
        var details = $("#details").val(infoContent);//把获取到的内容赋值给hidden隐藏域
        $("#upBussiness").submit();
    }
</script>