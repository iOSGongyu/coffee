								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-responsive">
                                            <form action="/Admin/Learn/lists" id="search" method="post">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                <?php if(is_array($districtlist)): $i = 0; $__LIST__ = $districtlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
														<td class="center">
															<label>
																<input type="checkbox" class="ace" />
																<span class="lbl"></span>
                                                        ...
                                                        <td><img src="/Public/Uploads/<?php echo ($row["img"]); ?>" width="50" height="50"/></td>
														<td><?php echo (mb_substr($row["describe"],0,5,'utf-8')); ?>...</td>
														<td class="hidden-480">
															<span><?php echo (mb_substr($row['businessinfo'],0,5,'utf-8')); ?>...</span>
														</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo U('Learn/learnInformationUpdate');?>?id=<?php echo ($row["casid"]); ?>">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="<?php echo U('Learn/del');?>?id=<?php echo ($row["casid"]); ?>">
