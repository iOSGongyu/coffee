            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form" enctype="multipart/form-data" action="http://cms2.erdangjiade.cn/Admin/Ajax/update" method="post" id="upBussiness">
                            <?php if(is_array($districtlist)): foreach($districtlist as $key=>$row2): ?><input type="hidden" name="id" value="<?php echo ($row2["casid"]); ?>">
                                ...
                                <div class="chosen-container chosen-container-multi" >
                                    ...
                                    <div class="col-sm-2">
                                        <select id="categorySelect" class="form-control" name="categoryId">
                                            <option value="<?php echo ($row2["cid"]); ?>"selected="selected"><?php echo ($row2["categoryname"]); ?></option>
                                            <?php if(is_array($categoryData)): foreach($categoryData as $key=>$row): ?><option value="<?php echo ($row["cid"]); ?>"  ><?php echo ($row["categoryname"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="wysiwyg-editor" id="editor1" name="editor1"><?php echo (html_entity_decode($row2["detail"])); ?></div>
