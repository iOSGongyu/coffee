                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form">
                            <?php if(is_array($wechat)): foreach($wechat as $key=>$row2): ?><div class="form-group">
                                    <input type="hidden" value="<?php echo ($row2["id"]); ?>" id="wechatid">
                                    <label for="form-field-1" class="col-sm-3 control-label no-padding-right">公众号名称： </label>

                                    <div class="col-sm-4">
                                        <input type="text" value="<?php echo ($row2["publicname"]); ?>" id="publicname">
                                    </div>
                                </div>
                                <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">
                                        <button type="button" class="btn btn-info" onclick="wechatUpdate();">
...
<script>
    function wechatUpdate(){
        ...
        var data = {"wechatid":wechatid,"publicname":publicname};
        $.get('http://www.demo.cn/Admin/Ajax/wechatUpdate',data,function(rs){
            if(rs==1){
                alert('修改成功');
                location.href='../wechat/lists';
            }else{
                alert('系统错误，请联系管理员');
            }
