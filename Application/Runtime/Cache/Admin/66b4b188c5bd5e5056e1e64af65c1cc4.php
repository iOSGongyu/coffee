...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-responsive">
            <form action="lists" id="search" method="post">
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                ...
                <?php if(is_array($orderList)): foreach($orderList as $key=>$row): ?><tr>
                        ...
                        <td><?php if($row["status"] == 0 ): ?>未付款<?php elseif($row["status"] == 1 ): ?>已付款<?php elseif($row["status"] == 2 ): ?>制作中<?php elseif($row["status"] == 3 ): ?>推广中<?php else: ?>订单完成<?php endif; ?></td>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="green" href="http://cms2.erdangjiade.cn/Admin/Order/updateOrder?id=<?php echo ($row["id"]); ?>">
