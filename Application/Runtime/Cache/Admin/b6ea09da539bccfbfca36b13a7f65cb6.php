								...
								<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-responsive">
                                            <form action="/Admin/User/agentUserList" id="search" method="post">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                                ...
                                                <?php if(is_array($agentList)): foreach($agentList as $key=>$row): ?><tr>
														<td class="center">
															<label>
																<input type="checkbox" class="ace" />
																<span class="lbl"></span>
                                                        ...
                                                        <td ><?php echo ($row["wechatslogan"]); ?></td>
                                                        <td><?php echo ($row["realname"]); ?></td>
                                                        <td><?php echo ($row["sex"]); ?></td>
                                                        <td ><?php echo ($row["idno"]); ?></td>
                                                        <td><img src="/Public/Uploads/agent/<?php echo ($row["idimgface"]); ?>" width="50" height="50"/></td>
                                                        <td><img src="/Public/Uploads/agent/<?php echo ($row["idimgback"]); ?>" width="50" height="50"/></td>
                                                        <td ><?php echo ($row["invitedcode"]); ?></td>
                                                        ...
                                                        <td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="red" href="<?php echo U('User/agentdel');?>?id=<?php echo ($row["id"]); ?>">
...
<script>
    function logout(){
        ...
        $.get('http://cms2.erdangjiade.cn/Admin/Login/logout',data,function(rs){
            if(rs==1){
                alert('退出成功');
                location.href='http://cms2.erdangjiade.cn/Admin/Login/';
            }else{
                alert('系统错误，请联系管理员');
            }
        });
...
<script>
    ...
    function selectpage(){
        ...
        var data={"records":records};
        $.get('http://cms2.erdangjiade.cn/Admin/Ajax/articleNumber',data,function(rs,sta){
            if(rs==1){
                location.href='http://cms2.erdangjiade.cn/Admin/User/agentUserList';
            }
        })
