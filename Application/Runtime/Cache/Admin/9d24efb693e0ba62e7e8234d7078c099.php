                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">邀请码：</label>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button type="button" class="btn btn-info" onclick="invitationAdd();">
...
<script>
    function invitationAdd(){
        var invitation_code = $('#form-field-1').val();

        //邀请码两位数字+五位字母组成
        if(!invitation_code.match(/^[0-9]{2}[A-Za-z]{5}$/)){
            alert("亲，添加的邀请码格式有误");
        }else{

            var data = {"invitation_code":invitation_code};
            $.get('http://www.moban.cn/Admin/Ajax/invitationAdd',data,function(data){
                if(data==100){
                    alert("亲，添加的邀请码已存在！换一个吧");
                }else if(data==101){
                    alert("添加成功");
                    $('#form-field-1').val('');
                }else{
