    ...
    <div class="col-xs-12">
        ...
        <div class="table-responsive">
            ...
            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                ...
                <?php if(is_array($wechatList)): foreach($wechatList as $key=>$row): ?><tr>
                        <td class="center">
                            <label>
                                <input type="checkbox" class="ace" />
                                <span class="lbl"></span>
                        ...
                        <td><?php if($row["type"] == 0 ): ?>新闻<?php else: ?>案例<?php endif; ?></td>
                        <td class="hidden-480"><?php echo (date('Y-m-d H:i:s',$row["createtime"])); ?></td>
                        ...
                        <td>
                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                ...
                                <a class="green" href="<?php echo U('Wechat/wechatUpdate');?>?id=<?php echo ($row["id"]); ?>">
                                    <i class="icon-pencil bigger-130"></i>
                                </a>

                                <a class="red" href="http://www.cms2.cn/Admin/Ajax/wechatdel?id=<?php echo ($row["id"]); ?>">
