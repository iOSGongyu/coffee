...
<li class="sidebar-dashboard <?php if($leftSadebarActive == 1): ?>active open<?php endif; ?>">
    <a href="http://cms2.erdangjiade.cn/Admin/index/">
                 ...
                 <b class="arrow icon-angle-down"></b>
                    ...
                    <ul class="submenu">
                        ...
                        <li <?php if($leftInvitationAdd == 1): ?>class="active"<?php endif; ?>>
                            <a href="http://cms2.erdangjiade.cn/Admin/User/invitationAdd">
...
<li <?php if($leftCategoryManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftCategoryAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://cms2.erdangjiade.cn/Admin/Category/categoryAdd">
                <i class="icon-double-angle-right"></i>
                添加分类
            </a>
        </li>
...
<li <?php if($leftLearnManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftLearnAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://cms2.erdangjiade.cn/Admin/Learn/learnInformationAdd">
                <i class="icon-double-angle-right"></i>
                添加案例
            </a>
        </li>
...
<ul class="submenu">
    ...
    <a href="http://cms2.erdangjiade.cn/Admin/Wechat/wechatAdd">
        <i class="icon-double-angle-right"></i>
        添加tag
    </a>
    </li>
...
<li <?php if($leftNewsManager == 1): ?>class="active open"<?php endif; ?>  >
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftNewsAdd == 1): ?>class="active"<?php endif; ?>>
            <a href="http://cms2.erdangjiade.cn/Admin/News/newsAdd">
                <i class="icon-double-angle-right"></i>
                添加新闻
            </a>
        </li>
...
<li <?php if($leftAdminUserManager == 1): ?>class="active open"<?php endif; ?> <?php if($_SESSION['role'] != 0): ?>style="display:none"<?php endif; ?>>
    ...
    <ul class="submenu">
        ...
        <li <?php if($leftAdminUserAdd == 1): ?>class="active"<?php endif; ?> >
            <a href="http://cms2.erdangjiade.cn/Admin/Web/userAdd" class="dropdown-toggle">
                <i class="icon-plus"></i>
                添加管理员
            </a>
        </li>
        ...
        <a href="#" class="dropdown-toggle">
            ...
            <ul class="submenu">
                ...
                <a href="http://cms2.erdangjiade.cn/Admin/Seo/lists" >
                    <i class="icon-plus"></i>
                    SEO列表
                </a>
                </li>
                ...
                <a href="http://cms2.erdangjiade.cn/Admin/Seo/seoAdd">
                    <i class="icon-eye-open"></i>
                    添加SEO
                </a>
                </li>
...
<li <?php if($calendar == 1): ?>class="active"<?php endif; ?>>
    <a href="http://cms2.erdangjiade.cn/Admin/Other/calendar">
...
<script>
    function changeagentUserRecords(){
        ...
        $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms2.erdangjiade.cn/Admin/User/agentUserList';
            }
        })
    }
    function changecommonUserRecords(){
        ...
        $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms2.erdangjiade.cn/Admin/User/commonUserList';
            }
        })
    }
    function changeinvitationRecords(){
        ...
        $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms2.erdangjiade.cn/Admin/User/invitationLists';
            }
        })
    }
    function changeCategoryRecords(){
        ...
        $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
                if(rs==1){
                    location.href='http://cms2.erdangjiade.cn/Admin/Category/lists';
                }
         })
    }
            function changeLearnRecords(){
                ...
                $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms2.erdangjiade.cn/Admin/Learn/lists';
                    }
                })
            }
            ...
            function changeWechatRecords(){
                ...
                $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms2.erdangjiade.cn/Admin/Wechat/lists';
                    }
                })
            }
            function changeBrandRecords(){
                ...
                $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms2.erdangjiade.cn/Admin/Wechat/brandLists';
                    }
                })
            }
    ...
    function changenoticeRecords(){
        ...
        $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms2.erdangjiade.cn/Admin/News/noticeLists';
            }
        })
    }
    function changeactivityRecords(){
        ...
        $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms2.erdangjiade.cn/Admin/News/activityList';
            }
        })
    }
    function changenewsRecords(){
        ...
        $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
            if(rs==1){
                location.href='http://cms2.erdangjiade.cn/Admin/News/lists';
            }
        })
    }
            function changeOrderRecords(){
                ...
                $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms2.erdangjiade.cn/Admin/Order/lists';
                    }
                })
            }
            function changeWebRecords(){
                ...
                $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms2.erdangjiade.cn/Admin/Web/userList';
                    }
                })
            }
            function changeMessageRecords(){
                ...
                $.get('http://cms2.erdangjiade.cn/Admin/Ajax/changeRecords',data,function(rs){
                    if(rs==1){
                        location.href='http://cms2.erdangjiade.cn/Admin/Web/messageLists';
                    }
                })
            }
</script>
                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                    <label for="form-field-select-1" class="col-sm-3 control-label no-padding-right">标题：</label>
                                    <div class="col-sm-2">
                                        <select class="width-80 chosen-select" id="form-field-select-3" data-placeholder="Choose a Country...">
                                            <?php if(is_array($districtName)): foreach($districtName as $key=>$row): ?><option value="<?php echo ($row["id"]); ?>"><?php echo ($row["title"]); ?></option><?php endforeach; endif; ?>
                                            <?php if(is_array($casetag)): foreach($casetag as $key=>$rowcase): ?><option value="<?php echo ($rowcase["id"]); ?>"><?php echo ($rowcase["title"]); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> tag： </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-2" placeholder="添加tag" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        ...
                                        <span class="lbl">案例</span>
                                    </label>
                                    <label>
                                        <input type="radio" class="ace" value="0" name="type">
                                        <span class="lbl">文章</span>
                                    </label>
                                </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button type="button" class="btn btn-info" onclick="wechatAdd();">
...
<script src="<?php echo ($url_admin); ?>assets/js/chosen.jquery.min.js"></script>
<link rel="stylesheet" href="<?php echo ($url_admin); ?>assets/css/chosen.css" />
<script type="text/javascript">
    jQuery(function($) {
...
<script type="text/javascript">
    ...
    function wechatAdd(){
        var publicName = $('#form-field-2').val();
        var districtId=$('#form-field-select-3').val();
        var type = $('input:radio[name=type]:checked').val();
        var data = {"publicName":publicName,"districtId":districtId,"type":type};
        $.post('http://cms2.erdangjiade.cn/Admin/Ajax/wechatAdd',data,function(rs){
            if(rs==1){
                alert('添加成功');
                $('#form-field-2').val('')
            }else{
