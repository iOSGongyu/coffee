                    ...
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> alias： </label>

                                <div class="col-sm-9">
                                    <input type="text" id="alias" placeholder="添加别名" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="title" placeholder="添加标题" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> keywords： </label>

                                <div class="col-sm-9">
                                    <input type="text" id="keywords" placeholder="添加关键字" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> desc： </label>

                                <div class="col-sm-9">
                                    <input type="text" id="desc" placeholder="添加描述" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function wechatAdd(){
        ...
        var desc=$('#desc').val();
        var data = {"alias":alias,"title":title,"keywords":keywords,"desc":desc};
        $.get('http://www.moban.cn/Admin/Ajax/seoAdd',data,function(rs){
            if(rs==101){
                alert('添加成功');
                $('#alias').val('');
                $('#title').val('');
